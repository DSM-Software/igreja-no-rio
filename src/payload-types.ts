...
export interface Post {
  ...
  /**
   * Cor usada quando não há imagem de capa.
   */
...
export interface Download {
  id: number;
  title: string;
  kind: 'audio' | 'pdf' | 'slides';
  /**
   * Ex.: Pregações, Estudos, Grupos Caseiros, Devocionais
   */
  category: string;
  date: string;
  speaker?: string | null;
  ...
  /**
   * Use quando o áudio é grande demais para upload.
   */
