# welcome-and-mission-copy Specification

## Purpose

Define a redação institucional do hero da home (`/`) e da seção "Missão" em `/quem-somos`, garantindo uma saudação acolhedora ("Seja bem-vindo") e uma comunicação clara da identidade da Igreja no Rio como família, ancorada em Romanos 8:29. Este capability cobre apenas o conteúdo textual visível dessas duas áreas — hierarquia visual e formatação de citação são preservadas para manter consistência com o restante do site.
